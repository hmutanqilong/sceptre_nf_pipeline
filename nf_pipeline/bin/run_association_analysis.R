...
# qltan commented [2025/07/29] uncommented [2025/8/1]
sceptre_object <- funct_to_run(sceptre_object)

# qltan added [2025/07/29] commented [2025/8/1]
#if (analysis_type == "run_power_check") {
#  sceptre_object <- funct_to_run(sceptre_object, parallel = T)
#} else {
#  sceptre_object <- funct_to_run(sceptre_object)
#}
